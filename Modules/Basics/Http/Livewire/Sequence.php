...
class Sequence extends Component
{
    ...
    public $document_name, $document, $number, $modelo;

    protected $listeners = ['showaudit','deleteItem', 'toggleItem'];
    ...
    {
        if ($this->selected_id) {
            $this->audit = $this->modelo::with(['creator', 'editor'])->find($this->selected_id)->toArray();
