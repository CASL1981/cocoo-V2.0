...
class CreateDetailOperationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_detail_operations', function (Blueprint $table) {
            ...
            $table->double('price', 8, 2)->default(0)->nullable()->comment('valor del producto');
            $table->double('discount', 8, 2)->default(0)->nullable()->comment('valor descuento');
            $table->double('discount_percentage', 8, 2)->default(0)->nullable()->comment('porcentage de descuento');            
            $table->double('subtotal', 8, 2)->default(0)->nullable()->comment('subtotal del producto en la orden');
            $table->double('tax_sale', 8, 2)->default(0)->nullable()->comment('valor de impuesto');
            $table->double('tax_sale_percentage', 8, 2)->default(0)->nullable()->comment('porcentage de impuesto');
            $table->double('total', 8, 2)->default(0)->nullable()->comment('total del producto en la orden');
